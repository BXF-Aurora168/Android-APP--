...
public class ListViewAdapter2 extends RecyclerView.Adapter<ListViewAdapter2.InnerHolder> {


    private final List<Clock> mData;

    public ListViewAdapter2(List<Clock> data){this.mData = data;}
    ...
    public InnerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view =View.inflate(parent.getContext(),R.layout.item_list_view2,null);
